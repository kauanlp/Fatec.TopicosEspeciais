    ...
    <div class="row">
        <div class="offset-lg-3 col-lg-6">
            ...
            <%
                ...
                if (pergunta!= null) {
            %>
            <p>Você realmente deseja excluir o pergunta ${pergunta.nome}?</p>
            <a href="pergunta?acao=confirmarExclusao&id=${pergunta.codigo}" class="btn btn-primary">Sim</a>
            <a href="index.jsp" class="btn btn-warning">Desisti!</a>
            <%
                } else {
                    out.println("Nenhum pergunta com este identificador foi encontrado");
                }
            %>
        </div>
    </div>
