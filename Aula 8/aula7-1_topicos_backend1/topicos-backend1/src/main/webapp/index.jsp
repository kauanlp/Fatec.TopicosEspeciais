        ...
        <div class="offset-lg-3 col-lg-6">
            ...
            <table class="table">
                ...
                <%
                    ...
                    if(null == contatos) {
                        request.getRequestDispatcher("/contato").forward(request, response);
                        return;
                    }
                ...
                <tr>
                    ...
                    <td><%= contato.getTelefone() %>
                    </td>
                    <td><%= contato.getEmail() %>
                    </td>
                    <td>
                        <a href="contato?acao=excluir&excluir=<%= contato.getCodigo() %>"><span class="fa-solid fa-trash text-danger"></span></a>
                        <a href="contato?acao=alterar&alterar=<%= contato.getCodigo() %>"><span class="fa-solid fa-pencil text-primary"></span></a>
                    </td>
                </tr>
                <%
                    }
            ...
            <p>Foram encontrados <%= contatos.size() %> contatos.</p>
        </div>
    </div>
</div>
</body>
