        ...
        <div class="col-md-6 mx-auto">
            ...
            <div class="card mb-4">
                    ...
                    <div class="flex-wrap w-100 align-items-center">
                        <div class="media">
                            ...
                            <div class="text-muted small ml-3">
                                <div>Publicado em <strong><%=question.getRegisterDate()%></strong></div>
                            </div>
                        </div>
                        <div class="small">
                            <div><strong><%=question.getTag()%></strong></div>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                ...
                <div class="card-footer d-flex flex-wrap justify-content-between align-items-center px-0 pt-0 pb-3">
                    <div class="px-4 pt-3">
                        <a href="question?action=findOne&questionId=<%= question.getId() %>" class="btn btn-secondary">Respostas</a>
                    </div>
                </div>
            </div>
            <%
            ...
            %>
            <div>
                <a href="saveQuestion.jsp" class="btn btn-primary">Adicionar Pergunta</a>
            </div>
        </div>
    </div>
</div>
