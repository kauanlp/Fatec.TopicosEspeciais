        ...
        <div class="offset-lg-3 col-lg-6">
            ...
            <table class="table">
                ...
                <%
                    ...
                    if(null == contatos) {
                        request.getRequestDispatcher("contatos").forward(request, response);
                        return;
                    }
                ...
                <tr>
                    ...
                    <td>
                        <a href="confirmarExclusao.jsp?id=<%= contato.getId() %>"><span class="fa-solid fa-trash text-danger"></span></a>
                        <a href="alterar.jsp?id=<%= contato.getId() %>"><span class="fa-solid fa-pencil text-primary"></span></a>
                    </td>
                </tr>
                <%
                    }
